...
### `model.py`
### Класс агенства недвижимости, который предоставяляет объекты (экземпляры класса), для снятия в аренду или покупки, отображает атрибуты класса и его экземпляров.
...
#### Сравниваем неравные объекты

![](./images/lab01/img13.png)

#### Сравниваем равные объекты
...
### Позволяет удобно обращаться к атрибутам объекта
